...
def test_polygamma_high_order():
    ...
    assert (
        ...
        == "(-0.00000000000000005225169411521692489752254721556835657523758895106315132447859377385233700094871256507814151956624433 - 0.00000000000000001813157041407010184702414110218205348527862196327980417757665282244728963891298080199341480881811613j)"
    )
    mp.dps = 15
...
def test_gamma_huge_2():
    ...
    assert (
        str(gamma(x))
        == "1.82341134776679e+51729974693233641689901335581750771368291828240422018860515119656908623426021308685461258226190190661"
    )
    mp.dps = 50
    assert (
        str(gamma(x))
        == "1.82341134776678875374414910350027596939980412984e+51729974693233641689901335581750771368291828240422018860515119656908623426021308685461258226190190661"
    )
...
def test_gamma_huge_3():
    ...
    assert (
        str(y.real)
        == "-6.82925203918106e+2636286142112569524501781477865238132302397236429627932441916056964386399485392600"
    )
    assert (
        str(y.imag)
        == "8.54647143678418e+2636286142112569524501781477865238132302397236429627932441916056964386399485392600"
    )
    mp.dps = 50
    y = gamma(x)
    assert (
        str(y.real)
        == "-6.8292520391810548460682736226799637356016538421817e+2636286142112569524501781477865238132302397236429627932441916056964386399485392600"
    )
    assert (
        str(y.imag)
        == "8.5464714367841748507479306948130687511711420234015e+2636286142112569524501781477865238132302397236429627932441916056964386399485392600"
    )
...
def test_gamma_huge_4():
    ...
    assert (
        str(gamma(x))
        == "(8.9578326853971339570292952697675570822206567327092e+5164 - 1.9467879832973509568895402139429643650329524144794e+5164j)"
    )
    mp.dps = 15
...
def test_gamma_huge_5():
    ...
    assert (
        str(y.real)
        == "-3.2775389963494132168950056995974690946983219123935e-227396058973640224580963937571892628368354580620654233316839"
    )
    assert (
        str(y.imag)
        == "-7.1519888950415979749736749222530209713136588885897e-227396058973640224580963937571892628368354580620654233316841"
    )
    mp.dps = 15
