...
def test_fp_cospi_sinpi():
    ...
    assert ae(fp.sinpi(1e-10), 3.1415926535897933529e-10)
    assert ae(
        fp.sinpi(1e-10 + 1e-10j),
        (3.141592653589793353e-10 + 3.1415926535897933528e-10j),
    )
    assert ae(
        fp.sinpi(1e-10 - 1e-10j),
        (3.141592653589793353e-10 - 3.1415926535897933528e-10j),
...
def test_fp_gamma():
    ...
    assert ae(
        fp.gamma(-3 - 4j), (0.00001460997305874775607 - 0.000020760733311509070396j)
    )
    ...
    assert ae(
        fp.loggamma(1e25 + 1e25j),
        (5.6125802751733671621e26 + 5.7696599078528568383e26j),
    )
    ...
    assert ae(
        fp.loggamma(-100 - 100j), (-632.35117666833135562 - 158.37641469650352462j)
    )
    ...
    assert ae(
        fp.loggamma(1e-10j - 1e-10), (22.679277339718205716 - 2.3561944902500664954j)
    )
...
def test_fp_zeta():
    ...
    assert ae(
        fp.zeta(1 + 0.000000001j), (0.57721566490153286061 - 999999999.99999993765j)
    )
    assert ae(
        fp.primezeta(2.5 + 4j), (-0.16922458243438033385 - 0.010847965298387727811j)
    )
...
def test_fp_hyp2f1():
    assert ae(
        fp.hyp2f1(1, (3, 2), 3.25, 5.0),
        (-0.46600275923108143059 - 0.74393667908854842325j),
    )
    assert ae(
        fp.hyp2f1(1 + 1j, (3, 2), 3.25, 5.0),
        (-5.9208875603806515987 - 2.3813557707889590686j),
    )
    assert ae(
        fp.hyp2f1(1 + 1j, (3, 2), 3.25, 2 + 3j),
        (0.17174552030925080445 + 0.19589781970539389999j),
    )
...
def test_fp_erf():
    ...
    assert ae(fp.erfc(-1j), (1.0 + 1.650425758797542876j))
    assert ae(
        fp.erfc((2 + 3j)), (21.829461427614568389 - 8.6873182714701631444j), 1e-13
    )
    assert ae(
        fp.erfc(-(2 + 3j)), (-19.829461427614568389 + 8.6873182714701631444j), 1e-13
    )
...
def test_fp_lambertw():
    ...
    assert ae(
        fp.lambertw(1e-10j), (1.0000000000000000728e-20 + 1.0000000000000000364e-10j)
    )
    ...
    assert ae(
        fp.lambertw(10000 + 1000j), (7.2361526563371602186 + 0.087567810943839352034j)
    )
    ...
    assert ae(
        fp.lambertw(4 + 0j, -1), (-0.15730793189620765317 - 4.6787800704666656212j)
    )
    ...
    assert ae(
        fp.lambertw(-1000.0, -1), (5.1501630246362515223 - 2.6641981432905204596j)
    )
    assert ae(fp.lambertw(1e-10, -1), (-26.303186778379041521 - 3.2650939117038283975j))
    assert ae(
        fp.lambertw(1e-10j, -1), (-26.297238779529035028 - 1.6328071613455765135j)
    )
    assert ae(
        fp.lambertw(3 + 4j, -1), (0.25856740686699741676 - 3.8521166861614355895j)
    )
    assert ae(
        fp.lambertw(-3 - 4j, -1), (-0.32028750204310768396 - 6.8801677192091972343j)
    )
    assert ae(
        fp.lambertw(10000 + 1000j, -1), (7.0255308742285435567 - 5.5177506835734067601j)
    )
    ...
    assert ae(
        fp.lambertw(3 + 4j, 2), (-0.86554679943333993562 + 11.849956798331992027j)
    )
    assert ae(
        fp.lambertw(-3 - 4j, 2), (-0.55792273874679112639 + 8.7173627024159324811j)
    )
    assert ae(
        fp.lambertw(10000 + 1000j, 2), (6.6223802254585662734 + 11.61348646825020766j)
    )
