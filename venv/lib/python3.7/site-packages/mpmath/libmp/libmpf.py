                ...
                if offset > 100 and prec:
                    ...
                    if delta > prec + 4:
                        ...
                        if tsign == ssign:
                            ...
                            sman -= 1
                        return normalize1(
                            ssign, sman, sexp - offset, bitcount(sman), prec, rnd
                        )
                # Add
                if ssign == tsign:
                ...
                if offset < -100 and prec:
                    ...
                    if delta > prec + 4:
                        ...
                        if ssign == tsign:
                            ...
                            tman -= 1
                        return normalize1(
                            tsign, tman, texp - offset, bitcount(tman), prec, rnd
                        )
                # Add
                if ssign == tsign:
...
def to_str(
    s, dps, strip_zeros=True, min_fixed=None, max_fixed=None, show_zero_exponent=False
):
    """
