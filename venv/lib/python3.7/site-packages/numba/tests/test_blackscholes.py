...
def blackscholes_arrayexpr_jitted(
...
def blackscholes_scalar_jitted(
    callResult, putResult, stockPrice, optionStrike, optionYears, Riskfree, Volatility
):
    S = stockPrice
    X = optionStrike
...
class TestBlackScholes(TestCase):
    def test_array_expr(self):
        ...
        cr2 = compile_isolated(
            blackscholes_arrayexpr_jitted,
    ...
    def test_scalar(self):
        ...
        signature = typing.make_concrete_template(
            "cnd_jitted", cnd_jitted, [cr1.signature]
        )
