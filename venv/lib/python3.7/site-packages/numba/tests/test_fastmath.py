...
class TestFastMath(unittest.TestCase):
    ...
    def test_jit_subset_code(self):
        ...
        self.assertTrue(
            ("fadd nsz reassoc" in fastllvm) or ("fadd reassoc nsz" in fastllvm),
            fastllvm,
        )
        self.assertTrue(
            ("call nsz reassoc" in fastllvm) or ("call reassoc nsz" in fastllvm),
            fastllvm,
        )
    ...
    def test_jit_subset_errors(self):
        ...
        self.assertIn(
            "Unrecognized fastmath flags:", str(raises.exception),
        )
        ...
        self.assertIn(
            "Expected fastmath option(s) to be", str(raises.exception),
        )
