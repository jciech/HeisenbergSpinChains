...
class TestTryBareExcept(TestCase):
    ...
    def test_nested_try(self):
        ...
        with captured_stdout() as stdout:
            udt(1, 0, 3)
        self.assertEqual(
            stdout.getvalue().split(), ["A", "call_one", "C", "call_other", "D"],
        )
    ...
    def test_loop_in_try(self):
        ...
        with captured_stdout() as stdout:
            res = udt(3, 5)
        self.assertEqual(
            stdout.getvalue().split(), ["A", "0", "1", "2", "3", "call_three", "B"],
        )
        ...
        with captured_stdout() as stdout:
            res = udt(1, 3)
        self.assertEqual(
            stdout.getvalue().split(), ["A", "0", "1", "call_one", "B"],
        )
        ...
        with captured_stdout() as stdout:
            res = udt(0, 3)
        self.assertEqual(
            stdout.getvalue().split(), ["A", "0", "call_other", "1", "2"],
        )
    ...
    def test_closure3(self):
        ...
        self.assertEqual(
            stdout.getvalue().split(), ["CAUGHT",] * 3,
        )
...
class TestTryExceptNested(TestCase):
    ...
    def test_try_except_else(self):
        ...
        for x, y, z, p in cases:
            self.check_compare(
                udt, udt.py_func, x=x, y=y, z=z, p=p,
            )
