...
skip_parfors_unsupported = unittest.skipIf(
    is_parfors_unsupported, "parfors not supported",
)
skip_py38_or_later = unittest.skipIf(
    utils.PYVERSION >= (3, 8), "unsupported on py3.8 or later"
)
...
skip_ppc64le_issue4026 = unittest.skipIf(
    platform.machine() == "ppc64le",
    "Hits: 'LLVM Invalid PPC CTR Loop! UNREACHABLE executed' bug",
)
