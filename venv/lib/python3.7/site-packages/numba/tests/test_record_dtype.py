...
recordtype = np.dtype(
    [("a", np.float64), ("b", np.int16), ("c", np.complex64), ("d", (np.str, 5))]
)
...
class TestRecordDtypeMakeCStruct(unittest.TestCase):
    def test_two_scalars(self):
        ...
        ty = types.Record.make_c_struct(
            [("apple", types.int32), ("orange", types.float32),]
        )
        # Correct offsets
    ...
    def test_three_scalars(self):
        ...
        ty = types.Record.make_c_struct(
            [("apple", types.int32), ("mango", types.int8), ("orange", types.float32),]
        )
        # Correct offsets
    ...
    def test_complex_struct(self):
        ...
        ty = types.Record.make_c_struct(
            [("apple", types.intc), ("mango", types.complex128),]
        )
        # Correct offsets
        self.assertEqual(len(ty), 2)
        self.assertEqual(ty.offset("apple"), Ref.apple.offset)
