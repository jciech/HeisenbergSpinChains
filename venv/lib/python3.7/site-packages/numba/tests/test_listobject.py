...
class TestAllocation(MemoryLeakMixin, TestCase):
    ...
    def test_list_allocation_negative(self):
        ...
        self.assertIn(
            "expecting *allocated* to be >= 0", str(raises.exception),
        )
    ...
    def test_list_getitem_empty_index_error(self):
        ...
        for i in (1, 0, -1):
            with self.assertRaises(IndexError) as raises:
                foo(i)
            self.assertIn(
                "list index out of range", str(raises.exception),
            )
    ...
    def test_list_getitem_empty_typing_error(self):
        ...
        for i in "xyz", 1.0, 1j:
            with self.assertRaises(TypingError) as raises:
                foo(i)
            self.assertIn(
                "list indices must be integers or slices", str(raises.exception),
            )
...
class TestGetitemSlice(MemoryLeakMixin, TestCase):
    ...
    def test_list_getitem_multiple_slice_zero_step_index_error(self):
        ...
        with self.assertRaises(ValueError) as raises:
            foo()
        self.assertIn(
            "slice step cannot be zero", str(raises.exception),
        )
...
class TestPop(MemoryLeakMixin, TestCase):
    ...
    def test_list_pop_empty_index_error_no_index(self):
        ...
        with self.assertRaises(IndexError) as raises:
            foo()
        self.assertIn(
            "pop from empty list", str(raises.exception),
        )
    ...
    def test_list_pop_singleton_typing_error_on_index(self):
        ...
        for i in "xyz", 1.0, 1j:
            with self.assertRaises(TypingError) as raises:
                foo(i)
            self.assertIn(
                "argument for pop must be an integer", str(raises.exception),
            )
...
class TestExtend(MemoryLeakMixin, TestCase):
    ...
    def test_list_extend_typing_error_non_iterable(self):
        ...
        with self.assertRaises(TypingError) as raises:
            foo()
        self.assertIn(
            "extend argument must be iterable", str(raises.exception),
        )
...
class TestInsert(MemoryLeakMixin, TestCase):
    ...
    def test_list_insert_typing_error(self):
        ...
        with self.assertRaises(TypingError) as raises:
            foo()
        self.assertIn(
            "list insert indices must be integers", str(raises.exception),
        )
...
class TestIndex(MemoryLeakMixin, TestCase):
    ...
    def test_index_singleton_value_error(self):
        ...
        with self.assertRaises(ValueError) as raises:
            foo()
        self.assertIn(
            "item not in list", str(raises.exception),
        )
    ...
    def test_index_typing_error_start(self):
        ...
        with self.assertRaises(TypingError) as raises:
            foo()
        self.assertIn(
            "start argument for index must be an integer", str(raises.exception),
        )
    ...
    def test_index_typing_error_end(self):
        ...
        with self.assertRaises(TypingError) as raises:
            foo()
        self.assertIn(
            "end argument for index must be an integer", str(raises.exception),
        )
...
class TestItemCasting(TestCase):
    ...
    def test_cast_fail_unicode_int(self):
        ...
        with self.assertRaises(TypingError) as raises:
            foo()
        self.assertIn(
            "cannot safely cast unicode_type to int32", str(raises.exception),
        )
    ...
    def test_cast_fail_int_unicode(self):
        ...
        with self.assertRaises(TypingError) as raises:
            foo()
        self.assertIn(
            "Cannot cast int32 to unicode_type", str(raises.exception),
        )
...
class TestImmutable(MemoryLeakMixin, TestCase):
    ...
    def test_append_fails(self):
        ...
        with self.assertRaises(ValueError) as raises:
            foo()
        self.assertIn(
            "list is immutable", str(raises.exception),
        )
