...
class TestUsecases(TestCase):
    ...
    def test_sum1d_pyobj(self):
        pyfunc = usecases.sum1d
        cr = compile_isolated(
            pyfunc, (types.int32, types.int32), flags=force_pyobj_flags
        )
        cfunc = cr.entry_point
    ...
    def test_string_concat(self):
        ...
        cr = compile_isolated(
            pyfunc, (types.int32, types.int32), flags=enable_pyobj_flags
        )
        cfunc = cr.entry_point
    ...
    def test_string_comparisons(self):
        ...
        cr = compile_isolated(
            pyfunc,
            (types.pyobject, types.pyobject, types.pyobject),
