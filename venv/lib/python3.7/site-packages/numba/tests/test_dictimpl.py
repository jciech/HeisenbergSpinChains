...
class Dict(object):
    ...
    def dict_new_minsize(self, key_size, val_size):
        dp = ctypes.c_void_p()
        status = self.tc.numba_dict_new_minsize(ctypes.byref(dp), key_size, val_size,)
...
class TestDictImpl(TestCase):
    def setUp(self):
        ...
        self.numba_dict_delitem = wrap(
            "dict_delitem",
            ctypes.c_int,
            [dict_t, hash_t, ctypes.c_ssize_t,],  # d  # hash  # ix
        )
        # numba_dict_popitem(
        #   NB_Dict *d,
        #   char *key_bytes,
        ...
        self.numba_dict_popitem = wrap(
            "dict_popitem",
            ctypes.c_int,
            [dict_t, ctypes.c_char_p, ctypes.c_char_p,],  # d  # key_bytes  # val_bytes
        )
    ...
    def test_popitem(self):
        ...
        with self.assertRaises(KeyError) as raises:
            d.popitem()
        self.assertIn(
            "popitem(): dictionary is empty", str(raises.exception),
        )
