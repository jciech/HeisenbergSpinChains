...
class TestBoundsCheckNoError(MemoryLeakMixin, unittest.TestCase):
    ...
    def test_basic_array_boundscheck(self):
        ...
        at = typeof(a)
        c_noboundscheck = compile_isolated(
            basic_array_access, [at], flags=DEFAULT_FLAGS
        )
    ...
    def test_slice_array_boundscheck(self):
        ...
        rt = float64[:]
        c_noboundscheck = compile_isolated(
            slice_array_access, [at], return_type=rt, flags=DEFAULT_FLAGS
        )
        noboundscheck = c_noboundscheck.entry_point
        c_boundscheck = compile_isolated(
            slice_array_access, [at], return_type=rt, flags=BOUNDSCHECK_FLAGS
        )
    ...
    def test_fancy_indexing_boundscheck(self):
        ...
        rt = at.dtype[:]
        c_noboundscheck = compile_isolated(
            fancy_array_access, [at], return_type=rt, flags=DEFAULT_FLAGS
        )
        noboundscheck = c_noboundscheck.entry_point
        c_boundscheck = compile_isolated(
            fancy_array_access, [at], return_type=rt, flags=BOUNDSCHECK_FLAGS
        )
        boundscheck = c_boundscheck.entry_point
        # Check that the default flag doesn't raise
        noboundscheck(a)
...
class TestBoundsCheckError(unittest.TestCase):
    ...
    def test_basic_array_boundscheck(self):
        ...
        at = typeof(a)
        c_boundscheck = compile_isolated(
            basic_array_access, [at], flags=BOUNDSCHECK_FLAGS
        )
        boundscheck = c_boundscheck.entry_point
