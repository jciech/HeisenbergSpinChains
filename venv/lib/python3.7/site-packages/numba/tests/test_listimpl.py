...
class TestListImpl(TestCase):
    def setUp(self):
        ...
        self.numba_list_iter_next = wrap(
            "list_iter_next",
            ctypes.c_int,
            [iter_t, ctypes.POINTER(ctypes.c_void_p),],  # it  # item_ptr
        )
