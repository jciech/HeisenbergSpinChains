...
from numba import float32, float64, int16, int32, boolean, deferred_type, optional
...
class TestJitClass(TestCase, MemoryLeakMixin):
    ...
    def test_spec_errors(self):
        ...
        with self.assertRaises(TypeError) as raises:
            jitclass(spec1)(Test)
        self.assertIn(
            "spec values should be Numba type instances", str(raises.exception)
        )
        with self.assertRaises(TypeError) as raises:
            jitclass(spec2)(Test)
    ...
    def test_globals(self):
        ...
        self.assertEqual(
            str(raises.exception), "class members are not yet supported: constant"
        )
