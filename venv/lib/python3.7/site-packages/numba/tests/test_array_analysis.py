...
class ArrayAnalysisPass(FunctionPass):
    ...
    def run_pass(self, state):
        state.array_analysis = ArrayAnalysis(
            state.typingctx,
            state.func_ir,
...
class TestArrayAnalysis(TestCase):
    ...
    def test_base_cases(self):
        ...
        self._compile_and_test(
            test_2, (types.intp, types.intp), asserts=[self.with_assert("a", "b")]
        )
        ...
        self._compile_and_test(
            ...
            asserts=[self.with_assert("a", "b"), self.without_assert("d", "e")],
        )
        ...
        self._compile_and_test(
            test_7,
            (types.intp, types.intp),
            asserts=[self.with_assert("a", "b"), self.without_assert("d", "a")],
        )
        ...
        self._compile_and_test(
            test_8,
            (types.intp, types.intp),
            asserts=[self.with_assert("b", "a"), self.with_assert("b", "d")],
        )
        ...
        self._compile_and_test(
            test_9, (types.intp,), asserts=[self.with_assert("A", "B")]
        )
        ...
        self._compile_and_test(
            test_tup_arg, (types.Tuple((int_arr_typ, int_arr_typ)),), asserts=None
        )
        ...
        self._compile_and_test(
            test_namedtuple, (types.intp,), equivs=[self.with_equiv("r", ("n", "n"))],
        )
        ...
        self._compile_and_test(
            test_np_where_tup_return, (types.Array(types.intp, 1, "C"),), asserts=None
        )
        ...
        self._compile_and_test(
            test_shape, (types.Array(types.intp, 2, "C"),), asserts=None
        )
        ...
        self._compile_and_test(
            test_cond, (types.intp, types.intp, types.intp), asserts=None
        )
        ...
        self._compile_and_test(
            test_assert_2,
            (types.Array(types.intp, 1, "C"), types.Array(types.intp, 1, "C"),),
            asserts=None,
        )
        self._compile_and_test(
            test_assert_2,
            (types.Array(types.intp, 2, "C"), types.Array(types.intp, 2, "C"),),
            asserts=None,
        )
        # expected failure
        with self.assertRaises(AssertionError) as raises:
            self._compile_and_test(
                test_assert_2,
                (types.Array(types.intp, 1, "C"), types.Array(types.intp, 2, "C"),),
                asserts=None,
            )
    ...
    def test_stencilcall(self):
        ...
        self._compile_and_test(
            test_2, (types.intp,), equivs=[self.without_equiv("a", "b")]
        )
    ...
    def test_numpy_calls(self):
        ...
        self._compile_and_test(
            test_identity, (types.intp,), equivs=[self.with_equiv("a", ("n", "n"))]
        )
        ...
        self._compile_and_test(
            test_random,
            (types.intp,),
            equivs=[self.with_equiv(*vars1d), self.with_equiv(*vars2d)],
        )
