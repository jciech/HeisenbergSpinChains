...
class TestOperators(TestCase):
    ...
    generate_binop_tests(
        ...
        {"ints": "run_binop_ints", "floats": "run_binop_floats_floordiv",},
    )
    ...
    generate_binop_tests(
        locals(), ("pow", "ipow"), {"ints": "run_pow_ints", "floats": "run_pow_floats",}
    )
    ...
    generate_binop_tests(
        locals(), ("bitshift_left", "bitshift_ileft"), {"ints": "run_bitshift_left",}
    )
    ...
    generate_binop_tests(
        locals(), ("bitshift_right", "bitshift_iright"), {"ints": "run_bitshift_right",}
    )
    ...
    generate_binop_tests(
        ...
        {"ints": "run_logical", "bools": "run_binop_bools",},
    )
...
class TestMixedInts(TestCase):
    ...
    def run_unary(
        self, pyfunc, control_func, operands, types, expected_type=utils.INT_TYPES
    ):
        for xt in types:
    ...
    def run_arith_binop(self, pyfunc, opname, samples, expected_type=utils.INT_TYPES):
        self.run_binary(
            pyfunc,
    ...
    def test_pow(self):
        ...
        self.run_binary(pyfunc, control_signed, samples, signed_pairs)
