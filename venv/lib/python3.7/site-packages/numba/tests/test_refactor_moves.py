...
class TestAPIMoves_Q1_2020(TestCase):
    ...
    def check_warning(self, from_mod, to_mod):
        ...
        def checker(fn=None, skip=False):
            ...
            for x in w:
                ...
                if fn is not None:
                    c4 = "Import of '{}' requested".format(fn) in str(x.message)
                else:
                    c4 = True
    ...
    def test_numba_config(self):
        checker = self.check_warning("numba.config", "numba.core.config")
        with checker(skip=IS_PY36):
            import numba.config
    ...
    def test_numba_unsafe_ndarray(self):
        checker = self.check_warning("numba.unsafe.ndarray", "numba.np.unsafe.ndarray")
        with checker():
    ...
    def test_numba_typing_typeof(self):
        checker = self.check_warning("numba.typing.typeof", "numba.core.typing.typeof")
        with checker():
    ...
    def test_numba_typed_passes(self):
        checker = self.check_warning("numba.typed_passes", "numba.core.typed_passes")
        with checker(skip=IS_PY36):
    ...
    def test_numba_targets_boxing(self):
        checker = self.check_warning("numba.targets.boxing", "numba.core.boxing")
        with checker():
    ...
    def test_numba_targets_callconv(self):
        checker = self.check_warning("numba.targets.callconv", "numba.core.callconv")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_hashing(self):
        checker = self.check_warning("numba.targets.hashing", "numba.cpython.hashing")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_ufunc_db(self):
        checker = self.check_warning("numba.targets.ufunc_db", "numba.np.ufunc_db")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_slicing(self):
        checker = self.check_warning("numba.targets.slicing", "numba.cpython.slicing")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_setobj(self):
        checker = self.check_warning("numba.targets.setobj", "numba.cpython.setobj")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_registry(self):
        checker = self.check_warning("numba.targets.registry", "numba.core.registry")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_options(self):
        checker = self.check_warning("numba.targets.options", "numba.core.options")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_listobj(self):
        checker = self.check_warning("numba.targets.listobj", "numba.cpython.listobj")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_imputils(self):
        checker = self.check_warning("numba.targets.imputils", "numba.core.imputils")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_builtins(self):
        checker = self.check_warning("numba.targets.builtins", "numba.cpython.builtins")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_arrayobj(self):
        checker = self.check_warning("numba.targets.arrayobj", "numba.np.arrayobj")
        with checker():
            import numba.targets
    ...
    def test_numba_targets_arraymath(self):
        checker = self.check_warning("numba.targets.arraymath", "numba.np.arraymath")
        with checker():
            import numba.targets
    ...
    def test_numba_runtime_nrt(self):
        checker = self.check_warning("numba.runtime.nrt", "numba.core.runtime.nrt")
        with checker():
    ...
    def test_numba_numpy_support(self):
        checker = self.check_warning("numba.numpy_support", "numba.np.numpy_support")
        if NOT_PY36:
            with checker():
    ...
    def test_numba_targets_npdatetime(self):
        checker = self.check_warning("numba.targets.npdatetime", "numba.np.npdatetime")
        with checker():
            import numba.targets
    ...
    def test_numba_npdatetime(self):
        ...
        checker = self.check_warning("numba.npdatetime", "numba.np.npdatetime_helpers")
        with checker(skip=IS_PY36):
    ...
    def test_numba_dispatcher(self):
        checker = self.check_warning("numba.dispatcher", "numba.core.dispatcher")
        with checker(skip=IS_PY36):
    ...
    def test_numba_dictobject(self):
        checker = self.check_warning("numba.dictobject", "numba.typed.dictobject")
        with checker(skip=IS_PY36):
    ...
    def test_numba_decorators(self):
        checker = self.check_warning("numba.decorators", "numba.core.decorators")
        with checker(skip=IS_PY36):
