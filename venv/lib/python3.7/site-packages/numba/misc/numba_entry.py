    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print(
                    "Error: Probing CUDA failed (device and driver present, runtime"
                    " problem?)\n"
                )
...
def make_parser():
    ...
    parser.add_argument(
        "--dump-llvm", action="store_true", help="Print generated llvm assembly"
    )
    parser.add_argument(
        "--dump-optimized", action="store_true", help="Dump the optimized llvm assembly"
    )
    parser.add_argument(
        "--dump-assembly", action="store_true", help="Dump the LLVM generated assembly"
    )
    parser.add_argument(
        "--dump-cfg",
        action="store_true",
    ...
    parser.add_argument(
        "--dump-ast", action="store_true", help="[Deprecated] Dump the AST"
    )
    parser.add_argument(
        "--annotate-html", nargs=1, help="Output source annotation as html"
    )
    parser.add_argument(
        "-s",
        "--sysinfo",
