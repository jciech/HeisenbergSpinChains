...
class HsaVectorize(deviceufunc.DeviceVectorize):
    ...
    def _get_globals(self, corefn):
        ...
        glbl.update({"__hsa__": roc, "__core__": corefn})
        return glbl
...
class HsaGUFuncVectorize(deviceufunc.DeviceGUFuncVectorize):
    def build_ufunc(self):
        ...
        return dispatch.HSAGenerializedUFunc(kernelmap=self.kernelmap, engine=engine)
    ...
    def _get_globals(self, sig):
        ...
        glbls.update({"__hsa__": roc, "__core__": corefn})
        return glbls
