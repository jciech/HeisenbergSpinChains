...
@lower(
    stubs.activelanepermute_wavewidth, types.Any, types.uint32, types.Any, types.bool_
)
...
lower(stubs.ds_bpermute, types.Any, types.Any)(
    _gen_ds_permute("llvm.amdgcn.ds.bpermute")
)
...
def _generic_array(context, builder, shape, dtype, symbol_name, addrspace):
    ...
    if addrspace == target.SPIR_LOCAL_ADDRSPACE:
        ...
        dataptr = context.addrspacecast(builder, gvmem, target.SPIR_GENERIC_ADDRSPACE)
