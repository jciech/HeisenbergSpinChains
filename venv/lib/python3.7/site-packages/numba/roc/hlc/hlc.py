...
class CmdLine(object):
    def _initialize(self):
        ...
        self.CMD_LINK_LIBS = " ".join([self.llvm_link, "-S", "-o {fout}", "{fin}"])

        self.CMD_LINK_BRIG = " ".join([self.ld_lld, "-shared", "-o {fout}", "{fin}"])
    ...
    def check_tooling(self):
        ...
        try:
            ...
            output = check_output([self.llc, "--version"], universal_newlines=True)
...
class Module(AMDGCNModule):
    ...
    def generateGCN(self):
        ...
        self._cmd.link_libs(ipath=llvmfile, libpaths=libpaths, opath=pre_builtin_path)
