...
class DeviceNDArrayBase(object):
    ...
    def copy_to_device(self, ary, stream=None, context=None):
        ...
        if stream is None:
            ...
            if isinstance(ary, DeviceNDArray):
                _driver.async_dGPU_to_dGPU(
                    dst_ctx=self._context,
    ...
    def copy_to_host(self, ary=None, stream=None):
        ...
        if self.alloc_size != 0:
            ...
            if stream is None:
                ...
                _driver.async_dGPU_to_host(
                    dst_ctx=devices.get_cpu_context(),
...
def from_array_like(ary, dgpu_data=None):
    ...
    if ary.ndim == 0:
        ary = ary.reshape(1)
    return DeviceNDArray(ary.shape, ary.strides, ary.dtype, dgpu_data=dgpu_data)
