...
hsa_amd_signal_handler = _PTR(
    ctypes.CFUNCTYPE(ctypes.c_bool, hsa_signal_value_t, ctypes.c_void_p)
)
...
HSA_EXT_PROGRAM_DESTROY_FPTR = ctypes.CFUNCTYPE(
    hsa_status_t, hsa_ext_program_t  # return value
)  # program

HSA_EXT_PROGRAM_ADD_MODULE_FPTR = ctypes.CFUNCTYPE(
    hsa_status_t, hsa_ext_program_t, hsa_ext_module_t  # return value  # program
)  # module
...
class hsa_ext_finalizer_1_00_pfn_t(ctypes.Structure):
    _fields_ = [
        ...
        ("hsa_ext_program_iterate_modules", HSA_EXT_PROGRAM_ITERATE_MODULES_FPTR),
...
HSA_ITER_AGENT_CALLBACK_FUNC = ctypes.CFUNCTYPE(
    hsa_status_t, hsa_agent_t, ctypes.py_object  # return value  # agent
)  # this is a c_void_p used to wrap a python object

HSA_QUEUE_CALLBACK_FUNC = ctypes.CFUNCTYPE(
    None, hsa_status_t, _PTR(hsa_queue_t), ctypes.py_object  # return value
)  # this is a c_void_p used to wrap a python object

HSA_AGENT_ITERATE_REGIONS_CALLBACK_FUNC = ctypes.CFUNCTYPE(
    hsa_status_t, hsa_region_t, ctypes.py_object  # return value  # region
)  # this is a c_void_p used to wrap a python object
...
HSA_CODE_OBJECT_ITERATE_SYMBOLS_CALLBACK = ctypes.CFUNCTYPE(
    hsa_status_t, hsa_code_object_t, hsa_code_symbol_t, ctypes.py_object  # return value
)  # this is a c_void_p used to wrap a python object
...
)  # this might need to be a ptr to a py_object

# hsa_status_t (*callback)(hsa_amd_memory_pool_t memory_pool, void* data)
HSA_AMD_AGENT_ITERATE_MEMORY_POOLS_CALLBACK = ctypes.CFUNCTYPE(
    hsa_status_t, hsa_amd_memory_pool_t, ctypes.c_void_p
)  # this is a c_void_p used to wrap a python object
...
API_PROTOTYPES = {
    ...
    "hsa_init": {"restype": hsa_status_t, "argtypes": [], "errcheck": _check_error},
    ...
    "hsa_code_object_get_info": {
        "restype": hsa_status_t,
        "argtypes": [hsa_code_object_t, hsa_code_object_info_t, ctypes.c_void_p],
        "errcheck": _check_error,
    },
    ...
    "hsa_code_object_get_symbol": {
        "restype": hsa_status_t,
        "argtypes": [hsa_code_object_t, ctypes.c_char_p, _PTR(hsa_code_symbol_t)],
        "errcheck": _check_error,
    },
    ...
    "hsa_code_symbol_get_info": {
        "restype": hsa_status_t,
        "argtypes": [hsa_code_symbol_t, hsa_code_symbol_info_t, ctypes.c_void_p],
        "errcheck": _check_error,
    },
    ...
    "hsa_executable_freeze": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [hsa_executable_t, ctypes.c_char_p,],
    },
    ...
    "hsa_executable_get_info": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [hsa_executable_t, hsa_executable_info_t, ctypes.c_void_p],
    },
    ...
    "hsa_executable_global_variable_define": {
        "restype": hsa_status_t,
        "argtypes": [hsa_executable_t, ctypes.c_char_p, ctypes.c_void_p],
        "errcheck": _check_error,
    },
    ...
    "hsa_executable_agent_global_variable_define": {
        "restype": hsa_status_t,
        "argtypes": [hsa_executable_t, hsa_agent_t, ctypes.c_char_p, ctypes.c_void_p],
        "errcheck": _check_error,
    },
    ...
    "hsa_executable_validate": {
        "restype": hsa_status_t,
        "argtypes": [hsa_executable_t, _PTR(ctypes.c_uint32)],
        "errcheck": _check_error,
    },
    ...
    "hsa_amd_coherency_get_type": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [hsa_agent_t, _PTR(hsa_amd_coherency_type_t),],
    },
    ...
    "hsa_amd_coherency_get_type": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [hsa_agent_t, hsa_amd_coherency_type_t,],
    },
    # hsa_status_t HSA_API
    ...
    "hsa_amd_profiling_set_profiler_enabled": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [_PTR(hsa_queue_t), ctypes.c_int,],
    },
    ...
    "hsa_amd_profiling_convert_tick_to_system_domain": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [ctypes.c_uint64, _PTR(ctypes.c_uint64)],
    },
    # hsa_status_t HSA_API
    ...
    "hsa_amd_async_function": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [ctypes.POINTER(void_fn_ptr), ctypes.c_void_p,],
    },
    # uint32_t HSA_API
    ...
    "hsa_amd_queue_cu_set_mask": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [_PTR(hsa_queue_t), ctypes.c_uint32, _PTR(ctypes.c_uint32)],
    },
    # hsa_status_t HSA_API
    ...
    "hsa_amd_memory_pool_can_migrate": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [hsa_amd_memory_pool_t, hsa_amd_memory_pool_t, _PTR(ctypes.c_bool)],
    },
    ...
    "hsa_amd_memory_migrate": {
        "errcheck": _check_error,
        "restype": hsa_status_t,
        "argtypes": [ctypes.c_void_p, hsa_amd_memory_pool_t, ctypes.c_uint32],
    },
