...
class TestCodeGeneration(unittest.TestCase):
    def test_copy_kernel(self):
        ...
        self.assertIn(".globl\t{0}".format(kernel.entry_name), kernel.assembly)
...
class TestKernelArgument(unittest.TestCase):
    ...
    def test_float64(self):
        self._test_template(nbtype=types.float64, src=1.0 / 3.0)

    def test_float32(self):
        self._test_template(nbtype=types.float32, src=1.0 / 3.0)
...
class TestDeviceFunction(unittest.TestCase):
    def test_device_function(self):
        ...
        devfn = compiler.compile_device(
            udt_devfunc, arytype.dtype, [arytype, types.intp]
        )
        ...
        kernel = compiler.compile_kernel(udt_devfunc_caller, [arytype, arytype])
