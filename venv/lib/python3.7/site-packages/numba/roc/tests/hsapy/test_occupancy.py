...
class TestOccupancy(unittest.TestCase):
    ...
    def test_limits_1(self):
        inputs = dict(group_size=400, vgpr_per_workitem=139, sgpr_per_wave=49)
        outputs = dict(
            ...
            occupancy=0,
            reasons=set(["allowed_wave_due_to_vgpr", "allowed_wave", "group_size"]),
        )
        self.check_limits(inputs, outputs)

    def test_limits_2(self):
        inputs = dict(group_size=256, vgpr_per_workitem=139, sgpr_per_wave=49)
        outputs = dict(
            allowed_wave_due_to_sgpr=10,
            allowed_wave_due_to_vgpr=1,
            allowed_wave=1,
    ...
    def test_limits_3(self):
        inputs = dict(group_size=2048, vgpr_per_workitem=16, sgpr_per_wave=70)
        outputs = dict(
            ...
            occupancy=0,
            reasons=set(["allowed_wave_due_to_sgpr", "allowed_wave", "group_size"]),
        )
        self.check_limits(inputs, outputs)

    def test_limits_4(self):
        inputs = dict(group_size=2048, vgpr_per_workitem=32, sgpr_per_wave=50)
        outputs = dict(
            allowed_wave_due_to_sgpr=10,
    ...
    def test_limits_5(self):
        inputs = dict(group_size=4, vgpr_per_workitem=128, sgpr_per_wave=10)
        outputs = dict(
    ...
    def test_limits_6(self):
        inputs = dict(group_size=4, vgpr_per_workitem=257, sgpr_per_wave=3)
        outputs = dict(
            ...
            allowed_vgpr_per_workitem=256,
            occupancy=0,
            reasons=set(["allowed_wave_due_to_vgpr", "allowed_wave"]),
        )
        self.check_limits(inputs, outputs)
