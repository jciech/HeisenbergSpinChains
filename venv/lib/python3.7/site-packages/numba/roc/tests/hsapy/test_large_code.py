...
class TestLargeCode(unittest.TestCase):
    def test_far_jump(self):
        ...
        numba_dir = os.path.abspath(
            os.path.join(os.path.dirname(numba.__file__), os.pardir)
        )
        script, ext = os.path.splitext(
            os.path.relpath(run_far_branch.__file__, numba_dir)
        )
