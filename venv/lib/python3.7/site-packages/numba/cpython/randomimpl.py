...
@lower("random.randrange", types.Integer, types.Integer, types.Integer)
...
@lower("random.triangular", types.Float, types.Float, types.Float)
...
@lower("random.gammavariate", types.Float, types.Float)
...
@lower("random.betavariate", types.Float, types.Float)
...
@lower("random.expovariate", types.Float)
...
@lower("random.lognormvariate", types.Float, types.Float)
...
@lower("random.weibullvariate", types.Float, types.Float)
...
@lower("random.vonmisesvariate", types.Float, types.Float)
...
def multinomial(n, pvals, size=None):
    ...
    if not isinstance(pvals, (types.Sequence, types.Array)):
        raise TypeError(
            "np.random.multinomial(): pvals should be an array or sequence, got %s"
            % (pvals,)
        )
    ...
    if size in (None, types.none):
        ...
        raise TypeError(
            "np.random.multinomial(): size should be int or tuple or None, got %s"
            % (size,)
        )
