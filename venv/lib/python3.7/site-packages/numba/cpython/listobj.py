...
class ListInstance(_ListPayloadMixin):
    ...
    def resize(self, new_size):
        ...
        def _payload_realloc(new_allocated):
            ...
            ptr = context.nrt.meminfo_varsize_realloc(
...
@lower_builtin("list.index", types.List, types.Any, types.Integer)
def list_index(context, builder, sig, args):
...
@lower_builtin("list.index", types.List, types.Any, types.Integer, types.Integer)
def list_index(context, builder, sig, args):
