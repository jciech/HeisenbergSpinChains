...
class StencilFunc(object):
        ...
        for block in kernel.blocks.values():
            ...
            for stmt in block.body:
                ...
                if (
                    ...
                    raise ValueError(
                        "Assignments to arrays passed to stencil "
                ...
                if (
                    ...
                    if ndim == 1:
                        ...
                        if isinstance(stmt_index_var_typ, types.misc.SliceType):
                            sa_var = ir.Var(
                                scope, ir_utils.mk_unique_var("slice_addition"), loc
                            )
    ...
    def _type_me(self, argtys, kwtys):
        ...
        if self.neighborhood is not None and len(self.neighborhood) != argtys[0].ndim:
            raise ValueError(
                "%d dimensional neighborhood specified for %d dimensional input array"
