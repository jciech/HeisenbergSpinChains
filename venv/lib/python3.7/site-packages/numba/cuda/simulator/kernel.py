...
class BlockThread(threading.Thread):
    ...
    def __init__(self, f, manager, blockIdx, threadIdx):
        ...
        self.thread_id = self.threadIdx.x + blockDim.x * (
            self.threadIdx.y + blockDim.y * self.threadIdx.z
        )
    ...
    def syncthreads_count(self, value):
        self._manager.block_state[
            self.threadIdx.x, self.threadIdx.y, self.threadIdx.z
        ] = value
        self.syncthreads()
