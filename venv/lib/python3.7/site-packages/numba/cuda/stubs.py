...
def grid_expand(ndim):
    ...
    return ir.Intrinsic(fname, typing.signature(restype, types.intp), args=[ndim])
...
class shared(Stub):
    ...
    array = Macro(
        "shared.array", shared_array, callable=True, argnames=["shape", "dtype"]
    )
    """
...
class local(Stub):
    ...
    array = Macro(
        "local.array", local_array, callable=True, argnames=["shape", "dtype"]
    )
    """
...
class const(Stub):
    ...
    array_like = Macro(
        "const.array_like", const_array_like, callable=True, argnames=["ary"]
    )
    """
