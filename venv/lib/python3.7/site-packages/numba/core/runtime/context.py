...
class NRTContext(object):
    ...
    def meminfo_alloc_dtor(self, builder, size, dtor):
        ...
        fn = mod.get_or_insert_function(fnty, name="NRT_MemInfo_alloc_dtor_safe")
        fn.return_value.add_attribute("noalias")
    ...
    def meminfo_alloc_aligned(self, builder, size, align):
        ...
        fn = mod.get_or_insert_function(fnty, name="NRT_MemInfo_alloc_safe_aligned")
        fn.return_value.add_attribute("noalias")
    ...
    def meminfo_new_varsize_dtor(self, builder, size, dtor):
        ...
        mod = builder.module
        fnty = ir.FunctionType(cgutils.voidptr_t, [cgutils.intp_t, cgutils.voidptr_t])
        fn = mod.get_or_insert_function(fnty, name="NRT_MemInfo_new_varsize_dtor")
    ...
    def meminfo_data(self, builder, meminfo):
        ...
        mod = builder.module
        fn = mod.get_or_insert_function(meminfo_data_ty, name="NRT_MemInfo_data_fast")
