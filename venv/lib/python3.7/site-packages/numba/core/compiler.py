...
_LowerResult = namedtuple("_LowerResult", ["fndesc", "call_helper", "cfunc", "env",])
...
def compile_isolated(func, args, return_type=None, flags=DEFAULT_FLAGS, locals={}):
    ...
    with cpu_target.nested_context(typingctx, targetctx):
        return compile_extra(
            typingctx, targetctx, func, args, return_type, flags, locals
        )
...
class DefaultPassBuilder(object):
    ...
    def define_interpreted_pipeline(state, name="interpreted"):
        ...
        pm = PassManager(name)
        pm.add_pass(CompileInterpMode, "compiling with interpreter mode")
        pm.finalize()
        return pm
