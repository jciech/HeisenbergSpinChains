...
class IterLoopCanonicalization(FunctionPass):
    ...
    def transform(self, loop, func_ir, cfg):
        ...
        get_range_var = ir.Var(
            func_ir.blocks[loop.header].scope, tokenise("get_range_gbl"), LOC
        )
        ...
        call_get_range_var = ir.Var(entry_block.scope, tokenise("call_get_range"), LOC)
        ...
        inline_closure_call(
            func_ir, glbls, entry_block, idx, get_range,
        )
