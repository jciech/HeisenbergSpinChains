...
from numba.core.imputils import lower_builtin, lower_constant, impl_ret_untracked
...
def scale_timedelta(context, builder, val, srcty, destty):
    ...
    if factor is None:
        ...
        raise NotImplementedError(
            "cannot convert timedelta64 from %r to %r" % (srcty.unit, destty.unit)
        )
...
normal_year_months = make_constant_array(
    [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]
)
leap_year_months = make_constant_array([31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31])
