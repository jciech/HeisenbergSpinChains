...
class Module(object):
    ...
    def add_metadata(self, operands):
        ...
        if not isinstance(operands, (list, tuple)):
            raise TypeError(
                "expected a list or tuple of metadata values, got %r" % (operands,)
            )
    ...
    def declare_intrinsic(self, intrinsic, tys=(), fnty=None):
        def _error():
            raise NotImplementedError(
                "unknown intrinsic %r with %d types" % (intrinsic, len(tys))
            )
