...
class TestLatexRepr(object):
    ...
    def test_simple_polynomial(self):
        ...
        assert_equal(
            self.as_latex(p),
            r"$x \mapsto 1.0 + 2.0\,\left(1.0 + x\right) + 3.0\,\left(1.0 +"
            r" x\right)^{2}$",
        )
        ...
        assert_equal(
            self.as_latex(p),
            r"$x \mapsto 1.0 + 2.0\,\left(1.0 + 2.0x\right) + 3.0\,\left(1.0 +"
            r" 2.0x\right)^{2}$",
        )
    ...
    def test_basis_func(self):
        ...
        assert_equal(
            self.as_latex(p),
            r"$x \mapsto 1.0\,{T}_{0}(1.0 + 2.0x) + 2.0\,{T}_{1}(1.0 + 2.0x) +"
            r" 3.0\,{T}_{2}(1.0 + 2.0x)$",
        )
