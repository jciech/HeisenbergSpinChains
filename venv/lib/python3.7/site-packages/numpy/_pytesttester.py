...
class PytestTester(object):
    ...
    def __call__(
        ...
        pytest_args += [
            ...
            r"-W ignore:comparing unequal types not supported in"
            r" 3\.x:DeprecationWarning",
            r"-W ignore:the commands module has been removed in Python"
            r" 3\.0:DeprecationWarning",
            r"-W ignore:The 'new' module has been removed in Python"
            r" 3\.0:DeprecationWarning",
        ]
